...
Read `docs/DEPLOYMENT.zh-CN.md` and `docs/CODEX-DEPLOY.md` before deployment. Use the stage-based diagnostic workflow; a 16GB hardware label is not a memory-fit guarantee.
